...
DARKNET_PATH = '/app/service/src/application/services/person_tracker/CNN/' # "/detection/darknet/Program/CNN"
...
def detect_image(network, class_names, image, thresh=.1, hier_thresh=.1, nms=.20):
    """
